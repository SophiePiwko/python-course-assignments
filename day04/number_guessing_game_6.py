...
def game():
    ...
    while True:
        ...
        guess = input("Pick a number between 1 and 20, x to exit the game, s to show the random number, d for the debug toggle or n to start a new game. What is your pick?").strip()
